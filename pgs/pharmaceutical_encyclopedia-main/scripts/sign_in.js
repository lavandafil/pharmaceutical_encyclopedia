...
let showp = document.getElementById('show_pass');
let pass_f = document.getElementById('pass_field');
function regShow(){
...
function showPass(){
    if(showp.className == 'fa-regular fa-eye eye'){
        showp.className = 'fa-regular fa-eye-slash eye';
        pass_f.type = 'text';
    }
    else{
        showp.className = 'fa-regular fa-eye eye';
